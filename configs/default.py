...
class DefaultEngineConfig():
    def __init__(self, exp_name='default', model='aott'):
        ...
        self.DATA_SEQ_LEN = 8 #10 if 'mobilenetv2' in self.MODEL_ENCODER else 6
    ...
    def init_dir(self):
        self.DIR_DATA = '/proj/cvl/users/x_fahkh/Abdelrahman/VOS/aot-benchmark/datasets'
        ...
        self.DIR_LONGVIDEO = os.path.join(self.DIR_DATA, 'LongVideo')
        self.DIR_LVOS = os.path.join(self.DIR_DATA, 'LVOS')
