...
class LVOS_Train(VOSTrain):
    def __init__(self,
        ...
        image_root = os.path.join(root, split+'_480p', "JPEGImages")
        label_root = os.path.join(root, split+'_480p', "Annotations")
        seqs = sorted(os.listdir(self.image_root))
        ...
        super(LVOS_Train, self).__init__(image_root,
                                              label_root,
                                              imglistdic,
                                              transform,
                                              rgb,
