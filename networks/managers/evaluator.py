...
from dataloaders.eval_datasets import YOUTUBEVOS_Test, YOUTUBEVOS_DenseTest, DAVIS_Test, LongVideo_Test, LVOS_Test, EVAL_TEST
...
class Evaluator(object):
    ...
    def prepare_dataset(self):
        ...
        elif cfg.TEST_DATASET == 'longvideo':
            self.result_root = os.path.join(cfg.DIR_EVALUATION,
                                            cfg.TEST_DATASET, eval_name,
                                            'Annotations')
            self.dataset = LongVideo_Test(
                split=[cfg.TEST_DATASET_SPLIT],
                root=cfg.DIR_LONGVIDEO,
                transform=eval_transforms,
                result_root=self.result_root)

        elif cfg.TEST_DATASET == 'lvos':
            self.result_root = os.path.join(cfg.DIR_EVALUATION,
                                            cfg.TEST_DATASET, eval_name,
                                            'Annotations')
            self.dataset = LVOS_Test(
                split=[cfg.TEST_DATASET_SPLIT],
                root=cfg.DIR_LVOS,
                transform=eval_transforms,
                result_root=self.result_root)
