...
from dataloaders.train_datasets import LVOS_Train, DAVIS2017_Train, YOUTUBEVOS_Train, StaticTrain, TEST
...
class Trainer(object):
    ...
    def process_pretrained_model(self):
        ...
        #Configuration from LOG of Best checkpoint
        
        #cfg.TRAIN_AUTO_RESUME = False
        #cfg.TRAIN_RESUME = False
        #cfg.PRETRAIN = True
        #cfg.PRETRAIN_FULL=False
        #cfg.PRETRAIN_MODEL = "/proj/cvl/users/x_fahkh/Abdelrahman/VOS/AOT/aot/result/save_step_0.pth"
        #cfg.TRAIN_START_STEP = 0

        
        #Seoncd Run
        #cfg.TRAIN_AUTO_RESUME=True
    ...
    def prepare_dataset(self):
        ...
        if 'lvos' in cfg.DATASETS:
            train_lvos_dataset = LVOS_Train(
                root=cfg.DIR_LVOS,
                transform=composed_transforms,
                repeat_time=cfg.DATA_DAVIS_REPEAT,
                seq_len=cfg.DATA_SEQ_LEN,
                ...
                enable_prev_frame=self.enable_prev_frame,
                max_obj_n=cfg.MODEL_MAX_OBJ_NUM)
            train_datasets.append(train_elvos_dataset)
