...
from networks.layers.externel_utils import MemoryJointModulation
...
class DeAOT(AOT):
    def __init__(self, cfg, encoder='mobilenetv2', decoder='fpn'):
        ...
        self.long_term_memory_attention = nn.ModuleList([nn.ModuleList([
            MemoryJointModulation(128, num_heads=4),
            MemoryJointModulation(512, num_heads=4),
            None,
            MemoryJointModulation(512, num_heads=4),
        ]) for _ in range(3)])
        self._init_weight()
